        ...
        <div className="flex min-h-screen transition-colors duration-300 font-sans selection:bg-cyan-500/30">
            ...
            <div className="flex-1 md:ml-64 flex flex-col w-full md:w-[calc(100%-16rem)] relative z-10 transition-all duration-300">
                ...
                <main className="flex-1 p-0 md:p-6 overflow-x-hidden">
                    ...
                    <div className="min-h-full rounded-none md:rounded-2xl glass-panel relative overflow-hidden backdrop-blur-xl border-x-0 md:border border-gray-200 dark:border-gray-800 p-3 md:p-6">
                        ...
                        <div className="hidden sm:block absolute bottom-0 left-0 w-8 h-8 border-b-2 border-l-2 border-cyan-500/50 rounded-bl-xl pointer-events-none"></div>
                        <div className="hidden sm:block absolute bottom-0 right-0 w-8 h-8 border-b-2 border-r-2 border-cyan-500/50 rounded-br-xl pointer-events-none"></div>
