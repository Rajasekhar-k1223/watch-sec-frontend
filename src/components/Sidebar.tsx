...
export default function Sidebar() {
    ...
    return (
        <aside className="w-64 bg-gray-900/80 backdrop-blur-xl border-r border-gray-800 h-screen flex flex-col fixed left-0 top-0 z-50 transition-all">
            <div className="p-6 border-b border-gray-800/50 bg-black/20">
            ...
            <div className="p-4 border-t border-gray-800">
                <div className="bg-gray-800 rounded-lg p-3">
                    ...
                    <button
                        onClick={() => logout()}
                        className="w-full flex items-center justify-center gap-2 bg-red-500/10 hover:bg-red-500/20 text-red-500 border border-red-500/20 rounded-md py-1.5 text-xs font-bold transition-all"
                    >
                        Log Out
                    </button>
                </div>
