...
export default function Landing() {
    ...
    return (
        <div className="min-h-screen bg-white dark:bg-[#020617] text-gray-900 dark:text-white selection:bg-blue-500/30 overflow-x-hidden font-sans transition-colors duration-300">
            <style>{`
                @keyframes marquee {
                ...
                <main className="flex-1 container mx-auto px-6 flex flex-col items-center justify-center text-center relative z-10 pb-20">
                    ...
                    <div className="reveal relative w-full max-w-6xl">
                        <TiltCard className="rounded-[2rem]">
                            <div className="relative bg-white dark:bg-[#0B0F19] rounded-[2rem] border border-gray-200 dark:border-gray-800 overflow-hidden shadow-2xl">
                                {/* Mock UI Header */}
            ...
            {/* -- LOGO MARQUEE -- */}
            <div className="bg-gray-50 dark:bg-black py-10 border-y border-gray-200 dark:border-white/5 overflow-hidden relative z-20">
            ...
            <section className="py-24 bg-gray-50 dark:bg-[#0B0F19] relative z-10 transition-colors">
            ...
            <section className="py-24 bg-white dark:bg-[#020617] relative z-10 overflow-hidden transition-colors">
            ...
            <section className="py-32 bg-white dark:bg-[#0B0F19] relative z-10 transition-colors">
                ...
                <div className="container mx-auto px-6">
                    <div className="reveal text-center mb-24 max-w-3xl mx-auto">
                        <span className="text-blue-600 dark:text-blue-500 font-bold uppercase tracking-widest text-sm mb-4 block">Platform Capabilities</span>
                        <h2 className="text-4xl md:text-5xl font-bold mb-6 text-gray-900 dark:text-white">Everything You Need.<br />Nothing You Don't.</h2>
                        <p className="text-gray-600 dark:text-gray-400 text-lg">Comprehensive security coverage for endpoints, networks, and cloud infrastructure.</p>
                    </div>
            ...
            <section className="py-32 bg-gray-50 dark:bg-[#020617] relative z-10 border-t border-gray-200 dark:border-gray-900 transition-colors">
                <div className="absolute left-0 bottom-0 w-[600px] h-[600px] bg-indigo-600/10 blur-[100px] pointer-events-none"></div>
                <div className="container mx-auto px-6">
                    <div className="reveal text-center mb-20">
                        <span className="text-blue-600 dark:text-blue-500 font-bold uppercase tracking-widest text-sm mb-4 block">Customer Success</span>
                        <h2 className="text-4xl font-bold mb-4 text-gray-900 dark:text-white">Trusted by Market Leaders</h2>
                    </div>
            ...
            {/* -- 3D CARDS: PRICING -- */}
            <section className="py-32 bg-white dark:bg-[#0B0F19] relative z-10 border-t border-gray-200 dark:border-gray-800 transition-colors">
                <div className="container mx-auto px-6">
                    <div className="reveal text-center mb-20">
                        <div className="inline-block px-4 py-1 rounded-full bg-green-500/10 text-green-600 dark:text-green-400 font-bold text-sm mb-4 animate-pulse">Limited Time Offer</div>
                        <h2 className="text-4xl font-bold mb-4 text-gray-900 dark:text-white">Transparent Pricing</h2>
                        <p className="text-gray-600 dark:text-gray-400">Choose the plan that scales with your business.</p>
                    </div>
            ...
            {/* -- FOOTER -- */}
            <footer className="bg-gray-50 dark:bg-[#020617] border-t border-gray-200 dark:border-gray-800 py-16 text-gray-500 dark:text-gray-500 text-sm transition-colors">
                <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                    <div className="col-span-1 md:col-span-1">
                        <div className="flex items-center gap-2 mb-6">
                            ...
                            <span className="font-bold text-xl text-gray-900 dark:text-white">Monitorix</span>
                        </div>
                        <p className="mb-6">The next generation of endpoint security for the distributed enterprise.</p>
                        <div className="flex gap-4">
                            <div className="w-10 h-10 bg-gray-200 dark:bg-gray-800 rounded-full flex items-center justify-center hover:bg-blue-600 hover:text-white transition-colors cursor-pointer"><Globe className="w-5 h-5" /></div>
                            <div className="w-10 h-10 bg-gray-200 dark:bg-gray-800 rounded-full flex items-center justify-center hover:bg-blue-600 hover:text-white transition-colors cursor-pointer"><Activity className="w-5 h-5" /></div>
                        </div>
                    </div>
                    <div>
                        <h4 className="font-bold text-gray-900 dark:text-white mb-6">Platform</h4>
                        <ul className="space-y-4">
                            <li className="hover:text-blue-600 dark:hover:text-blue-500 cursor-pointer">EDR</li>
                            <li className="hover:text-blue-600 dark:hover:text-blue-500 cursor-pointer">Productivity</li>
                            <li className="hover:text-blue-600 dark:hover:text-blue-500 cursor-pointer">Compliance</li>
                            <li className="hover:text-blue-600 dark:hover:text-blue-500 cursor-pointer">Download Agent</li>
                        </ul>
                    </div>
                    <div>
                        <h4 className="font-bold text-gray-900 dark:text-white mb-6">Resources</h4>
                        <ul className="space-y-4">
                            <li className="hover:text-blue-600 dark:hover:text-blue-500 cursor-pointer">Documentation</li>
                            <li className="hover:text-blue-600 dark:hover:text-blue-500 cursor-pointer">API Reference</li>
                            <li className="hover:text-blue-600 dark:hover:text-blue-500 cursor-pointer">Blog</li>
                            <li className="hover:text-blue-600 dark:hover:text-blue-500 cursor-pointer">Community</li>
                        </ul>
                    </div>
                    <div>
                        <h4 className="font-bold text-gray-900 dark:text-white mb-6">Company</h4>
                        <ul className="space-y-4">
                            <li className="hover:text-blue-600 dark:hover:text-blue-500 cursor-pointer">About Us</li>
                            <li className="hover:text-blue-600 dark:hover:text-blue-500 cursor-pointer">Careers</li>
                            <li className="hover:text-blue-600 dark:hover:text-blue-500 cursor-pointer">Legal</li>
                            <li className="hover:text-blue-600 dark:hover:text-blue-500 cursor-pointer">Contact</li>
                        </ul>
                    </div>
                </div>
...
function FeatureCard({ icon, title, desc, delay }: any) {
    return (
        <TiltCard className={`reveal delay-${delay} h-full rounded-3xl`}>
            <div className={`bg-white dark:bg-gray-900/50 border border-gray-200 dark:border-gray-800 p-8 rounded-3xl hover:bg-gray-50 dark:hover:bg-gray-800 transition-all h-full group hover:border-blue-500/30 shadow-lg`}>
                <div className="w-14 h-14 bg-gray-100 dark:bg-gray-800 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform group-hover:bg-blue-600/10 dark:group-hover:bg-blue-500/20 group-hover:text-blue-600 dark:group-hover:text-blue-400 shadow-sm group-hover:shadow-[0_0_15px_rgba(37,99,235,0.1)]">
                    {icon}
                </div>
                ...
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed font-medium">{desc}</p>
            </div>
        </TiltCard>
    );
}
...
function TestimonialCard({ quote, author, role, rating, delay }: any) {
    return (
        <TiltCard className={`reveal delay-${delay} h-full rounded-3xl`}>
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 p-8 rounded-3xl h-full relative group hover:border-blue-500/20 shadow-md">
                <div className="absolute top-4 right-8 text-6xl text-gray-200 dark:text-gray-800 font-serif opacity-50 select-none">"</div>
                <div className="flex gap-1 mb-6 text-yellow-500">
                    {[...Array(rating)].map((_, i) => <Star key={i} className="w-5 h-5 fill-current drop-shadow-[0_0_5px_rgba(234,179,8,0.5)]" />)}
                </div>
                <p className="text-xl text-gray-700 dark:text-gray-300 mb-8 italic relative z-10">{quote}</p>
...
function PricingCard({ name, price, period, features, recommended, cta, onClick, delay }: any) {
    return (
        <TiltCard className={`reveal delay-${delay} h-full rounded-3xl ${recommended ? 'scale-105 z-10' : ''}`} scale={1.02}>
            <div className={`relative bg-gray-50 dark:bg-gray-900/50 border rounded-3xl p-8 flex flex-col h-full transition-all ${recommended ? 'bg-white dark:bg-gray-900 border-blue-500 ring-4 ring-blue-500/10 shadow-2xl shadow-blue-500/10' : 'border-gray-200 dark:border-gray-800 hover:border-blue-300 dark:hover:border-gray-600 shadow-lg'}`}>
                {recommended && (
                ...
                <h3 className={`text-lg font-bold uppercase tracking-widest mb-4 ${recommended ? 'text-blue-600 dark:text-blue-400' : 'text-gray-500'}`}>{name}</h3>
                <div className="mb-8">
