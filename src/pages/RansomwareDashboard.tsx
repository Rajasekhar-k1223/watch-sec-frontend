  ...
  useEffect(() => {
    ...
    setIncidents([
      ...
      },
      {
        ...
        process_id: 0,
        heuristic: "VssadminDeletion: 4 -> 0",
      ...
      {
        id: 3,
        agent_id: "WIN-SRV-DB1",
        process_id: 0,
        heuristic: "HighEntropy: 7.95",
    ...
    <div className="p-4 md:p-6 space-y-6 bg-[#0a0a0a] min-h-screen text-white">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between border-b border-gray-800 pb-4">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-2xl md:text-3xl font-bold tracking-tight text-white">Ransomware Shield</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-[#1a1a1a] border-gray-800">
          <div className="p-6 flex items-center justify-between">
            <div>
              ...
              <p className="text-4xl font-bold text-[#00ff8e] mt-2">5</p>
            </div>
        ...
        <div className="bg-[#1a1a1a] border-gray-800">
          <div className="p-6 flex items-center justify-between">
            <div>
              <p className="text-gray-400 text-sm font-semibold">Max Fleet Entropy</p>
              <p className="text-4xl font-bold text-orange-400 mt-2">7.95</p>
            </div>
            <Activity className="w-10 h-10 text-orange-400 opacity-20" />
          </div>
        </div>
