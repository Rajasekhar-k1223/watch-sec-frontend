    ...
    return (
        <div className="p-8 bg-white dark:bg-gray-900 min-h-screen text-gray-900 dark:text-white font-sans animate-fade-in transition-colors">
            <div className="mb-8 border-b border-gray-200 dark:border-gray-800 pb-6">
                ...
                <p className="text-gray-500 dark:text-gray-400 mt-1">Welcome back, {user?.username}. Here is your daily summary.</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                {/* 1. Productivity Score */}
                <div className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700 shadow-xl flex flex-col items-center justify-center relative overflow-hidden">
                        ...
                        <ResponsiveContainer width="100%" height="100%">
                            <PieChart>
                                ...
                                >
                                    ...
                                    <Cell className="fill-gray-200 dark:fill-gray-700" stroke="none" />
                                </Pie>
                            </PieChart>
                        </ResponsiveContainer>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700 shadow-xl">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-3 p-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-900/50 rounded-lg">
                            <CheckCircle className="text-green-500" />
                            <div>
                                <p className="font-bold text-green-600 dark:text-green-400">System Secure</p>
                                <p className="text-xs text-gray-500 dark:text-gray-400">Antivirus Active, Firewall On</p>
                            </div>
                        </div>
                        ...
                        <div className="flex justify-between items-center text-sm">
                            <span className="text-gray-500 dark:text-gray-400">Agent Status</span>
                            <span className="text-blue-600 dark:text-blue-400 font-bold flex items-center gap-1"><span className="w-2 h-2 bg-blue-500 rounded-full animate-pulse" /> Connected</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700 shadow-xl">
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700 text-center text-xs text-gray-500">
                            Total Tracked Time: <span className="text-gray-900 dark:text-white font-bold">{Math.round(stats.totalSeconds / 60)} mins</span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    {stats.topApps?.map((app: any, i: number) => (
                        <div key={i} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-900 rounded-lg">
                            <div className="flex items-center gap-3 overflow-hidden">
                                ...
                                <span className="truncate font-medium text-gray-700 dark:text-gray-300" title={app.name}>{app.name}</span>
                            </div>
